...
All <span class="stixtype">identifiers</span>, excluding those used in the deprecated Cyber Observable Container, **MUST** follow the form <span class="stixalt">*object-type*--*UUID*</span>, where *<span class="stixalt">object-type</span>* is the exact value (all type names are lowercase strings, by definition) from the <span class="stixtype">type</span> property of the object being identified or referenced and where the *<span class="stixalt">UUID</span>* **MUST** be an RFC 9562-compliant UUID \[[RFC9562](#rfc9562)\].

\[[RFC9562](#rfc9562)\] obsoletes RFC 4122, the UUID specification referenced by earlier versions of this specification. It leaves unchanged the variant and version fields, the layouts of the UUID versions that RFC 4122 defined — including UUIDv4 (section 5.4 of \[[RFC9562](#rfc9562)\]) and UUIDv5 (section 5.5), on which the rules below rely — and the computation of name-based UUIDs from a namespace ID. An <span class="stixtype">identifier</span> that was compliant with RFC 4122 is therefore still compliant, and the deterministic <span class="stixtype">identifiers</span> defined in this section keep the same values as in previous versions of this specification. What RFC 9562 adds are the UUIDv6, UUIDv7, and UUIDv8 layouts (sections 5.6, 5.7, and 5.8), which the requirement above consequently admits as well; the version recommendations given below are unchanged. Producers using UUID versions that do not guarantee uniqueness on their own (e.g., UUIDv8) need to be mindful of the uniqueness requirements defined in this section.
...
STIX Domain Objects, STIX Relationship Objects, STIX Meta Objects, and STIX Bundle Object **SHOULD** use UUIDv4 for the *<span class="stixalt">UUID</span>* portion of the <span class="stixtype">identifier</span>. Producers using another UUID version need to be mindful of potential collisions and of the uniqueness requirement defined above. When generating a name-based UUID, such as a UUIDv5, they **SHOULD** use a namespace that guarantees uniqueness, and they **MUST NOT** use a namespace of <span class="stixliteral">00abedb4-aa42-466c-9c01-fed23315a9b7</span>.
...
- If the contributing properties are all optional, and none are present on the SCO, then the <span class="stixtype">identifier</span> cannot be deterministic and a UUIDv4 **SHOULD** be used. Any other UUID version defined by \[[RFC9562](#rfc9562)\] remains permitted, subject to the requirements defined above.
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    <td><a class="stixtype" href="#attack-pattern">attack-pattern</a></td>
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    <td><a class="stixtype" href="#course-of-action">course-of-action</a></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#timestamp">timestamp</a></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#infrastructure">infrastructure</a></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#open-vocabulary">open-vocab</a></td>
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    <td><a class="stixtype" href="#threat-actor">threat-actor</a></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    <td><strong>criticality</strong> (optional)</td>
    <td><a class="stixtype" href="#integer">integer</a></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    <td><a class="stixtype" href="#indicator">indicator</a></td>
    <td><span class='stixliteral'>based-on</span></td>
    <td><a class="stixtype" href="#observed-data">observed-data</a></td>
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    <td width="20%"><span class='stixtype'>course-of-action</span></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    ...
    <td><span class="stixtype">infrastructure</span>, <span class="stixtype">observed-data</span>, <span class="stixtype">&lt;All <em>STIX Cyber-observable Objects</em>&gt;</span></td>
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#vulnerability">vulnerability</a></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    <td><a class="stixtype" href="#intrusion-set">intrusion-set</a></td>
    <td><span class="stixliteral">attributed-to</span></td>
    <td><a class="stixtype" href="#threat-actor">threat-actor</a></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#float">float</a></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#boolean">boolean</a></td>
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    <td><a class="stixtype" href="#malware-analysis">malware-analysis</a></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#identifier">identifier</a></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#enum">enum</a></td>
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#binary">binary</a></td>
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#hashes">hashes</a></td>
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    <td><a class="stixtype" href="#domain-name-object">domain-name</a></td>
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    <td><strong>value</strong><br><br>If the <strong>value</strong> property is not present, a UUIDv4 <strong>SHOULD</strong> be used, and any other RFC 9562-compliant UUID version is permitted, as defined in <a href="#identifier">section 2.9</a>.</td>
  </tr>
</table>
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    <td><strong>from_ref</strong>, <strong>subject</strong>, <strong>body</strong><br><br>If none of these properties is present, a UUIDv4 <strong>SHOULD</strong> be used, and any other RFC 9562-compliant UUID version is permitted, as defined in <a href="#identifier">section 2.9</a>.</td>
  </tr>
</table>
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#dictionary">dictionary</a></td>
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#hexadecimal">hex</a></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    <td><a class="stixtype" href="#ipv4-address-object">ipv4-addr</a></td>
    <td><span class="stixliteral">resolves-to</span></td>
    <td><a class="stixtype" href="#mac-address-object">mac-addr</a></td>
  ...
  <tr>
    ...
    <td><a class="stixtype" href="#autonomous-system-as-object">autonomous-system</a></td>
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  <tr>
    <td><a class="stixtype" href="#ipv6-address-object">ipv6-addr</a></td>
    <td><span class="stixliteral">resolves-to</span></td>
    <td><a class="stixtype" href="#mac-address-object">mac-addr</a></td>
...
The Network Traffic object represents arbitrary network traffic that originates from a source and is addressed to a destination. The network traffic **MAY** constitute a valid unicast, multicast, or broadcast network connection. This **MAY** also include traffic that is not established, such as a SYN flood.
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    <td>Since all properties on this object are optional, no ID contributing properties are defined; a UUIDv4 <strong>SHOULD</strong> be used, and any other RFC 9562-compliant UUID version is permitted, as defined in <a href="#identifier">section 2.9</a>.</td>
  </tr>
</table>
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    <td><strong>account_type</strong>, <strong>user_id</strong>, <strong>account_login</strong><br><br>If none of these properties is present, a UUIDv4 <strong>SHOULD</strong> be used, and any other RFC 9562-compliant UUID version is permitted, as defined in <a href="#identifier">section 2.9</a>.</td>
  </tr>
</table>
...
<table border="1" cellspacing="0" cellpadding="6" width="100%">
  ...
  <tr>
    <td><strong>key</strong>, <strong>values</strong> <em>(all items defined in the <strong>values</strong> property <strong>MUST</strong> be included)</em><br><br>If none of these properties is present, a UUIDv4 <strong>SHOULD</strong> be used, and any other RFC 9562-compliant UUID version is permitted, as defined in <a href="#identifier">section 2.9</a>.</td>
  </tr>
</table>
